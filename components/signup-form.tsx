    ...
    <Card className="w-full max-w-md border-2 border-[#ff6800]/20 bg-black/80 backdrop-blur-xl shadow-2xl relative overflow-hidden">
      ...
      <CardHeader className="relative z-10 text-center pb-8">
        ...
        <CardDescription className="text-gray-400 text-base">
          Join IoTPulse and manage your IoT networks
        </CardDescription>
        ...
        <div className="space-y-5">
          ...
          <div className="relative py-2">
            ...
            <div className="relative flex justify-center">
              <span className="bg-black px-4 text-sm text-gray-500 font-playfair">or sign up with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500 font-playfair">Must be at least 6 characters</p>
            </div>

            <div className="space-y-2">
              <label htmlFor="confirm-password" className="text-sm font-semibold text-white font-playfair flex items-center gap-2">
                <CheckCircle className="h-4 w-4 text-[#ff6800]" />
                Confirm Password
              </label>
              <div className="relative group">
                <Input
